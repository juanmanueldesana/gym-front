    ...
    const [profile, setProfile] = useState({
      ...
      const signUp = (e) => {
        ...
        validateInfo(profile) === true
            ? axios.post("https://gym-austral-back.onrender.com/api/auth/signup/", {
                ...
                axios.post("https://gym-austral-back.onrender.com/api/auth/login/", { username: profile.username, password: profile.password }).then(
                  (res) => {
